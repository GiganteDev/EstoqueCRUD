...
<table class="table table-hover">
    ...
    while ($array = mysqli_fetch_array($busca)):
        ...
        $fornecedor_produto = $array['fornecedor_produto'];
      ?>
  <tr>
        <td><?php echo $id?></td>
        ...
        <td><?php echo $fornecedor_produto?></td>
        <td>
          <a class="btn btn-sm btn-warning" href="editar_produto.php?id=<?php echo $id ?>" role="button"><i class="far fa-edit"></i>&nbsp;Editar</a>
          <a class="btn btn-sm btn-danger" href="_deletar_produto.php?id=<?php echo $id ?>" role="button"><i class="far fa-trash-alt"></i>&nbsp;Deletar</a>
        </td>
      </tr>
  <?php endwhile ?>
        </tbody>
