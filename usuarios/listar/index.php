    ...
    <tbody>
        <?php
            ...
            while ($array = mysqli_fetch_array($busca)):
                ...
                $user_usuario = $array['user_usuario'];
        ...
        <tr>
            ...
            <td>
                <?php
                    echo ucfirst($nivel_usuario);
                ?>
            </td>
            <td>
                <?php
                  echo ucfirst($status_usuario)
                ?>
            </td>
            <td>
              <a class="btn btn-sm btn-danger" href="_deletar_usuario.php?id=<?php echo $id ?>" role="button"><i class="far fa-trash-alt"></i>&nbsp;Deletar</a>
              <a class="btn btn-sm btn-dark" href="<?php echo ($status_usuario == "inativo") ? "_ativar_usuario" : "_desativar_usuario"; ?>.php?id=<?php echo $id ?>" role="button"><i class="far fa-trash-alt"></i>&nbsp;<?php echo ($status_usuario == 'inativo') ? "Ativar" : "Desativar"; ?></a>
              <a class="btn btn-sm btn-warning" href="editar_usuario.php?id=<?php echo $id ?>" role="button"<?php echo ($status_usuario == "inativo") ? "style='display:none;'" : ''; ?>><i class="far fa-edit"></i>&nbsp;Editar</a>
            </td>
        </tr>
        <?php endwhile ?>
        </tbody>
